...
public partial class ShikiMetadataService : IDisposable
{
    ...
    private readonly Repository.IMetadataRepository _metadataRepo;
    private readonly Repository.IUserAnimeRepository _userAnimeRepo;
    ...
    public ShikiMetadataService(
        ...
        Repository.IMetadataRepository metadataRepo,
        Repository.IUserAnimeRepository userAnimeRepo,
        Repository.IHttpCacheRepository httpCacheRepo,
