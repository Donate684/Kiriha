...
{
    public static AnimeEntity MapJsonToAnimeEntity(JsonElement node)
    {
    ...
    public static void MapAlternativeTitles(JsonElement node, AnimeEntity item)
    {
    ...
    public static void MapGenresAndStudios(JsonElement node, AnimeEntity item)
    {
    ...
    public static void MapListStatus(JsonElement listStatus, AnimeEntity item)
    {
