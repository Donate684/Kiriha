...
public partial class AnimeEditViewModel : ObservableObject
{
    ...
    private readonly AnimeItem _anime;
    ...
    public AnimeEditViewModel(
        AnimeItem originalAnime,
        AnimeItem cloneAnime,
        ...
        HistoryService historyService)
    {
        ...
        {
            if (e.PropertyName == nameof(AnimeItem.Status))
    ...
    {
        _anime.DateStarted = System.DateTime.Now;
    }

    [RelayCommand]
    private void SetEndDateToToday()
    {
        _anime.DateCompleted = System.DateTime.Now;
    }
