...
public partial class AppSettings
{
    public class PlayerConfig
    {
        ...
        public double SubtitleFontSize { get; set; } = 80;
        ...
        public double SubtitleBorderSize { get; set; } = 4;
        ...
        public int SubtitleMarginY { get; set; } = 60;
        ...
        public bool MpvCorrectDownscaling { get; set; } = false;
        public bool MpvDeband { get; set; } = false;
        public int MpvDebandIterations { get; set; } = 1;
        public int MpvDebandThreshold { get; set; } = 30;
        public string MpvVideoPreset { get; set; } = "default";
