...
{
    private static readonly FrozenDictionary<string, string> FallbackStrings = new KeyValuePair<string, string>[]
    {
        new("schedule.today", "Today"),
        new("schedule.tomorrow", "Tomorrow"),
        new("schedule.yesterday", "Yesterday"),
        new("schedule.day_before_yesterday", "2 days ago"),
        new("schedule.days_ago", "{0}d ago"),
        new("schedule.hours_ago", "{0}h ago"),
        new("schedule.minutes_ago", "{0}m ago"),
        new("schedule.days_later", "in {0} d."),
        new("schedule.days_abbrev", "{0} d."),
        new("schedule.days_hours", "{0}d {1}h"),
        new("schedule.days_only", "{0}d"),
        new("schedule.hours_minutes", "{0}h {1}m"),
        new("schedule.minutes_only", "{0}m"),
        new("schedule.now", "now"),
        new("schedule.next_episode", "next episode"),
        new("schedule.episode_format", "Ep {0}"),
        new("schedule.latest_ep", "Latest episode"),
        new("schedule.premiere", "Premiere"),
        new("schedule.premiere_lower", "premiere"),
        new("schedule.releases_this_week", "{0} {1} this week"),
        new("schedule.releases_past_days", "{0} {1} in recent days"),
        new("schedule.release_1", "release"),
        new("schedule.release_2_4", "releases"),
        new("schedule.release_5_0", "releases"),
        new("schedule.no_dates", "No dates"),
        new("schedule.after_sync", "after sync"),
        new("schedule.no_future_dates", "No future dates in current data"),
        new("schedule.no_past_releases", "No recent releases"),
        new("schedule.no_past_releases_desc", "No new episodes from your list were released recently"),
        new("schedule.no_upcoming_releases", "No upcoming releases"),
        new("schedule.after_sync_roadmap", "After synchronization, the episode roadmap will appear here")
