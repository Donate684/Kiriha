...
public partial class SearchView : UserControl
{
    ...
    {
        if (e.Container.DataContext is Models.Entities.AnimeEntity item && DataContext is SearchViewModel vm)
        {
    ...
    private async void Poster_DoubleTapped(object? sender, Avalonia.Input.TappedEventArgs e)
    {
        ...
        try
        {
            if (sender is Control c && c.DataContext is Models.Entities.AnimeEntity item && DataContext is SearchViewModel vm)
            {
