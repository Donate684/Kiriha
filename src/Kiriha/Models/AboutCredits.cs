...
{
    public static IReadOnlyList<CreditEntry> DataSources { get; } = new[]
    {
    ...
    public static IReadOnlyList<CreditEntry> Inspirations { get; } = new[]
    {
    ...
    public static IReadOnlyList<CreditEntry> Libraries { get; } = new[]
    {
